...
/*   Updated: 2026/03/13 21:56:36 by wihumeau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parscmd(t_arg *pipex, char **av)
{
	...
	pipex->cmd1.args = checkcmd(av[2]);
	pipex->cmd2.args = checkcmd(av[3]);
	pipex->cmd1.path = assignpath(pipex->cmd1.args, pipex);
	pipex->cmd2.path = assignpath(pipex->cmd2.args, pipex);
}
